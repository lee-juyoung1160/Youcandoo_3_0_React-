...
export default function PrivacyLatest(props) {
      ...
      <Inner>
        ...
        <div className={styles.virtual_el}>
          ...
          <p>
            ...
            서비스의 전부 또는 일부 이용에 제한이 있을 수 있습니다. 개인정보의
            수집 내용은 아래와 같습니다.
          </p>
        ...
        <ul className={styles.date}>
          <li>공고일자 : 2021년 07월 16일</li>
          <li>시행일자 : 2021년 07월 23일</li>
        </ul>
        <Link href={`/${props.type}/v3.0/privacy/v1_4`}>
          <a>
            이전 개인정보 처리방침 보기
            <br />
            (2021년 06월 24일 ~ 2021년 07월 16일)
          </a>
        </Link>
      </Inner>
    </article>
