...
export default function Privacy_v1_0(props) {
      ...
      <Inner>
        ...
        <div className={styles.virtual_el}>
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td>(주)CJ대한통운, (주)건영물류시스템, (주)포유키즈</td>
                <td>서비스 물품 및 이벤트 경품 배송 등의 물류 업무</td>
              </tr>
              <tr>
                <td>
                  (주)KG이니시스, (주)엘지유플러스, (주)네이버파이낸셜,
                  (주)비바리퍼블리카, 한국정보통신(주), 엔에이치엔페이코(주),
                  (주)카카오페이
                </td>
                <td>
              ...
              <tr>
                <td>(주)가비아, (주)싸이웰시스템</td>
                <td>서버 호스팅 및 보안 관제</td>
              </tr>
              <tr>
                <td>(주)일공일랩</td>
                <td>집중케어 학습 커리큘럼 관리/진행</td>
              </tr>
              <tr>
                <td>Facebook, Google</td>
                <td>신규 서비스 및 이벤트 정보 안내/광고</td>
              </tr>
              <tr>
                <td>강의 진행 강사</td>
                <td>출석 및 강의 진행</td>
        ...
        <div className={styles.virtual_el}>
          ...
          <p>
            회사는 만 14세 미만의 아동의 개인정보는 관계법령이 허용하지 않는
            용도로는 사용하지 않고 있습니다. 회사는 아동의 개인정보를 보호하기
            위해 다음 각호의 조치를 하고 있습니다.
            <br />
            <br />
            ...
            보호지침]의 고지방법을 준수합니다.
            <br />
            <br />② 법정대리인은 만14세 미만 아동의 개인정보에 대한 열람, 수정
            및 삭제를 요청할 수 있으며, 회사는 이러한 요청에 지체 없이 필요한
            조치를 취합니다.
          </p>
        </div>
        <div className={styles.virtual_el}>
