...
export default function Privacy_v1_2(props) {
    ...
    <article className={styles.terms}>
      <Inner>
        ...
        <ul className={styles.date}>
          <li>공고일자 : 2020년 10월 19일</li>
          <li>시행일자 : 2020년 10월 23일</li>
        </ul>
        <Link href={`/${props.type}/v3.0/privacy/v1_1`}>
          <a>
            이전 개인정보 처리방침 보기
            <br />
            (2020년 08월 26일 ~ 2020년 10월 23일)
          </a>
        </Link>
      </Inner>
    </article>
