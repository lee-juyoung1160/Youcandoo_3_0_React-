    ...
    <div className={styles.root}>
      ...
      <div>
        <div className={styles.notice}>
          ...
          <ul>
            <li>
              <i>-</i>연속 인증수가 높을수록 레벨이 높아져요.
              <br />
              단, 하루에 유사한 인증을 여러 개 올릴 경우에는 레벨 심사 과정에서
              탈락할 수도 있어요.
            </li>
            <li>
              <i>-</i>내가 직접 올린 인증은 물론, 내가 만든 두잇에서 멤버들이
              올린 인증도 레벨 경험치에 포함되어요.
              <br />
              빠르게 레벨을 올리고 싶다고 리더십을 발휘해 더 많은 사람들의
              인증을 이끌어보세요!
            </li>
            <li>
